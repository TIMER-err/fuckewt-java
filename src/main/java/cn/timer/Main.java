                                    ...
                                    if (!lessonStat.contains("已完成")) {
                                        ...
                                        if (driver.getCurrentUrl().contains("xinli.ewt360.com") ||
                                            ...
                                            while (true) {
                                                ...
                                                if (currentTime instanceof Long && duration instanceof Long) {
                                                ...
                                                if (currentTime instanceof Double && duration instanceof Double) {
                                                ...
                                                if (currentTime instanceof Long && duration instanceof Double) {
                                                    if ((long) currentTime >= (double) duration * 1000) {
                                                        logger.info(lessonName + " | 已完成");
                                                        driver.close();
                                                        switchToNewTab();
                                                        break;
                                                ...
                                                if (currentTime instanceof Double && duration instanceof Long) {
                                                    if ((double) currentTime * 1000 >= (long) duration) {
                                                        logger.info(lessonName + " | 已完成");
                                                        driver.close();
                                                        switchToNewTab();
                                                        break;
